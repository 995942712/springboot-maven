...
layui.use(['bodyTab', 'form', 'element', 'layer', 'jquery'], function () {
    ...
    tab = layui.bodyTab({
        ...
        url: "/getUserModule?id=1"//获取菜单json地址
    });
    ...
    //         btn: ['火速围观'],
    //         moveType: 1,
    //         content: '<div style="padding:15px 20px; text-align:justify; line-height: 22px; text-indent:2em;border-bottom:1px solid #e2e2e2;"><p>在此特别感谢Beginner和Paco，他们写的框架给了我很好的启发和借鉴。希望有时间可以多多请教。</p></div>',
    ...
    //刷新当前,此处添加禁止连续点击刷新一是为了降低服务器压力,另外一个就是为了防止超快点击造成chrome本身的一些js文件的报错(不过貌似这个问题还是存在,不过概率小了很多)
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        if (data[i].children !== undefined && data[i].children.length > 0) {
            ...
            for (var j = 0; j < data[i].children.length; j++) {
                //==================================================二级菜单==================================================
                // if (data[i].children !== undefined && data[i].children.length > 0) {
                //     ulHtml += '<dd class="third-class"><a href="javascript:;">';
                ...
                //         }
                //     }
                //     ulHtml += '<cite>' + data[i].children[j].title + '</cite><span class="layui-nav-more"></span></a>';
                //     ulHtml += '<ol class="layui-nav-third-child">';
                //     for (var k = 0; k < data[i].children[j].children.length; k++) {
                //         //==================================================三级菜单==================================================
                //         if (data[i].children[j].children[k].target === "_blank") {
                //             ulHtml += '<li><a href="javascript:;" style="font-size: 20px" data-url="' + data[i].children[j].children[k].href + '" target="' + data[i].children[j].children[k].target + '">';
                //         } else {
                //             ulHtml += '<li><a href="javascript:;" style="font-size: 20px" data-url="' + data[i].children[j].children[k].href + '">';
                //         }
                ...
                //                 ulHtml += '<i class="iconfont ' + data[i].children[j].children[k].icon + '" style="font-size: 20px" data-icon="' + data[i].children[j].children[k].icon + '"></i>';
                //             } else {
                //                 ulHtml += '<i class="layui-icon" style="font-size: 20px" data-icon="' + data[i].children[j].children[k].icon + '">' + data[i].children[j].children[k].icon + '</i>';
                //             }
                //         }
