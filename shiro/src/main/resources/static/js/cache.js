...
layui.use(['form', 'jquery', "layer"], function () {
    ...
    if (window.sessionStorage.getItem('userFace') && $(".userAvatar").length > 0) {
        ...
        $(".userAvatar").attr("src", $(".userAvatar").attr("src").split("img/")[0] + "img/" + window.sessionStorage.getItem('userFace').split("img/")[1]);
    } else {
    ...
    function lockPage() {
        layer.open({
            ...
            '<div class="admin-header-lock-name" id="lockUserName">ming</div>' +
            '<div class="input_btn">' +
