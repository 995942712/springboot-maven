...
import com.ming.shiro.domain.vo.AuthUser;
import com.ming.shiro.service.security.ModuleService;
import com.ming.shiro.service.security.RoleService;
import com.ming.shiro.service.security.UserService;
...
public class BaseController {
    ...
    public AuthUser getCurrentUser() {
        ...
        if(StringUtil.isBlank(loginName)) {
            log.info("loginName为空");
            return new AuthUser();
        }
        User user = this.userService.findUserByLoginName(loginName);
        AuthUser authUser = new AuthUser(user.getId(), user.getLoginName(), "", "");
        return authUser;
    }
